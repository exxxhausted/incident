...
TEST_CASE("DFS", "[dfs][undirected]") {
    SECTION("DFS on simple connected graph") {
        /*
        0 -- 1 -- 3
        |    |
        2 __/
    ...
    SECTION("DFS handles disconnected graph") {
        /*
        0 -- 1

        2 -- 3

        DFS from 0 should visit only:
        0 1
        */
    ...
    SECTION("DFS ignores multiedge revisits") {
        /*
        Base graph:
    ...
    SECTION("DFS handles self-loops") {
        /*
        Base graph:
             __
            \ /
